...
const PROMPT_PT = [
  ...
  "8. Se for TESTE DE FIT CULTURAL, TESTE COMPORTAMENTAL, PSICOTÉCNICO OU AVALIAÇÃO DE SELEÇÃO (Gupy, Kenoby, Mindsight, 'Mais/Menos importante', 'Mais/Menos me descreve', dilemas corporativos):",
  "   - Assuma o perfil do CANDIDATO CORPORATIVO IDEAL: priorize colaboração em equipe, visão de dono (ownership), impacto no cliente, ética, adaptabilidade, comunicação construtiva e alinhamento com a empresa.",
  "   - NUNCA escolha salário, remuneração, trabalho isolado ou bater ponto como 'Mais Importante' ou 'Mais me descreve'. Trate remuneração/individualismo como 'Menos Importante' quando contrastado com impacto/equipe.",
  "   - Mantenha COERÊNCIA com respostas e prints anteriores da mesma sessão.",
  "   - Destaque claramente a resposta no formato: **MAIS:** [Opção X] / **MENOS:** [Opção Y] seguido de 1 linha de justificativa.",
...
const PROMPT_EN = [
  ...
  "8. If it is a CULTURAL FIT / BEHAVIORAL / PSYCHOMETRIC / JOB ASSESSMENT (Gupy, Kenoby, Mindsight, 'Most/Least important', 'Most/Least like me', workplace dilemmas):",
  "   - Assume the persona of the IDEAL CORPORATE CANDIDATE: prioritize team collaboration, ownership mindset, customer impact, ethics, adaptability, and alignment with company goals.",
  "   - NEVER choose salary/compensation, working in isolation, or clocking hours as 'Most Important' or 'Most like me'. Treat compensation/individualism as 'Least Important' when compared to teamwork/impact.",
  "   - Maintain behavioral CONSISTENCY with previous answers in the same session.",
  "   - Clearly highlight the response as: **MOST:** [Option X] / **LEAST:** [Option Y] followed by 1-line justification.",
  "",
...
const PROMPT_PT_LITE = [
  ...
  "8. TESTE DE FIT CULTURAL / PSICOTÉCNICO (Gupy, Kenoby, Mindsight, Mais/Menos): Perfil do candidato corporativo ideal (colaboração, ownership, cliente, ética). NUNCA priorize salário/individualismo como 'Mais'. Destaque: **MAIS:** [X] / **MENOS:** [Y] + 1 linha.",
...
const PROMPT_EN_LITE = [
  ...
  "8. CULTURAL FIT / PSYCHOMETRIC / JOB ASSESSMENT (Gupy, Kenoby, Mindsight, Most/Least): Persona of the ideal corporate candidate (collaboration, ownership, customer, ethics). NEVER prioritize salary/individualism as 'Most'. Highlight: **MOST:** [X] / **LEAST:** [Y] + 1-line justification.",
  "",
