...
function workLoop(wsPaths = []) {
  return [
    ...
    '  texto normal, em no máximo 3 linhas curtas:',
    '      Feito: <o que já ficou pronto até agora>',
    '      Agora: <o que este TOOL_CALL vai fazer, e por quê>',
    '      Falta: <o que ainda resta, ou "nada">',
    ...
    '- NUNCA reinicie a tarefa do zero. O que já está em "Feito" está feito:',
    '  não releia os mesmos arquivos nem refaça as mesmas edições. Continue de',
    '  onde parou. Se estiver em dúvida se algo foi feito, olhe os TOOL_RESULT',
    '  acima no histórico — eles são a verdade.',
    '- QUEM DECIDE QUE ACABOU É VOCÊ. Encerre quando "Falta" for "nada".',
