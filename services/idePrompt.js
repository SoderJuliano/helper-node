...
function workLoop(wsPaths = []) {
  return [
    ...
    '- O TOOL_RESULT É a confirmação da escrita: ok:false ou written:false = NÃO',
    '  escreveu; ok:true = escreveu. NÃO releia o arquivo só pra "conferir" o que',
    '  você mesmo acabou de escrever — isso gasta uma rodada inteira à toa.',
    '  Releia apenas se for editar o MESMO arquivo de novo. Só afirme',
    '  "criei/editei" quando o TOOL_RESULT confirmar. Não minta sobre isso.',
    '',
    '- PLANO NUMERADO, UMA VEZ SÓ: na sua PRIMEIRA mensagem do turno, antes de',
    '  qualquer TOOL_CALL, escreva o plano em texto normal:',
    '      Plano: 1) <passo>  2) <passo>  3) <passo>',
    '  Poucos passos, concretos, cada um terminando numa ação de ferramenta.',
    '  Depois disso o plano está FECHADO: não reescreva o plano, não replaneje,',
    '  não reavalie a abordagem. Execute os passos na ordem.',
    '- RELATÓRIO DE PROGRESSO (obrigatório): ANTES de cada TOOL_CALL, escreva em',
    '  texto normal, em no máximo 3 linhas curtas, citando o número do passo:',
    '      Feito: <passos já concluídos>',
    '      Agora: <passo N — o que este TOOL_CALL faz>',
    '      Falta: <passos restantes, ou "nada">',
    '  Esse texto vai pra tela do usuário e é como ele acompanha a tarefa e',
    '  percebe se você inventou alguma coisa. Escreva o relatório e, na linha',
    '  seguinte, o TOOL_CALL.',
    '- NÃO RELEIA o que já foi lido neste turno. Todo TOOL_RESULT anterior está',
    '  no histórico acima e continua válido — é a sua memória. Reler o mesmo',
    '  arquivo não traz informação nova, só queima uma rodada inteira.',
    '- NUNCA reinicie a tarefa do zero. O que está em "Feito" está feito: não',
    '  refaça as mesmas edições. Continue de onde parou.',
    '- QUEM DECIDE QUE ACABOU É VOCÊ, e você tem que ACABAR. Assim que escrever',
    '  "Falta: nada", a PRÓXIMA coisa que você emite é a resposta final em texto',
    '  normal, SEM nenhum TOOL_CALL — resumindo o que mudou e em quais arquivos.',
    '  Não emita mais ferramentas depois disso.',
    '- Pensou duas vezes a mesma coisa? Pare de pensar e execute o próximo passo',
    '  do plano. Se todos os passos acabaram, entregue a resposta final.',
