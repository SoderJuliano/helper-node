...
contextBridge.exposeInMainWorld("electronAPI", {
  ...
  openApiConfig: () => ipcRenderer.send("open-api-config-ui"),
  openWelcome: () => ipcRenderer.send("open-welcome-ui"),
  checkFirstRun: () => ipcRenderer.invoke("check-first-run"),
  setWelcomeCompleted: (val) => ipcRenderer.send("set-welcome-completed", val),
  ...
  getZaiApiKey: () => ipcRenderer.invoke("get-zai-api-key"),
  saveZaiApiKey: (key) => ipcRenderer.send("set-zai-api-key", key),
  getZaiBaseUrl: () => ipcRenderer.invoke("get-zai-base-url"),
