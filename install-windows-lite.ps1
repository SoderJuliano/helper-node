...
# Helper Node — instalador Windows (edição: lite, 100% online)
#
...
#
# Edição LITE: 100% online via OpenAI — mesma experiência da edição Lite do
...
Write-Host "Edicao LITE: 100% online via OpenAI, sem Ollama/Claude CLI/Gemini CLI/modelos locais." -ForegroundColor DarkGray
Write-Host ""
