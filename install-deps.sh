...
install_packages_debian() {
  ...
  # Base packages
  local packages="git nodejs make g++ curl ffmpeg cmake gnome-screenshot imagemagick python3 python3-venv python3-pip pipewire pipewire-utils pulseaudio-utils x11-utils wl-clipboard"
